"""
Django settings for the socialAPI project.
...
SECRET_KEY = 'django-insecure-y%l@$z&n$j4#lr0586s#a=(67!t(e%jy)b*zd5h9c7b+dc!03b'
...
# per compressione e il caching dei file grafici di DRF
...
# dico a django di usare il modello utente custom!
AUTH_USER_MODEL = 'users.CustomUser'

# configuro DRF per usare l'autenticazione jwt di default
REST_FRAMEWORK = {
